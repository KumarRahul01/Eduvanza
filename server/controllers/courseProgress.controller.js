...
export const handleUpdateLectureProgress = async (req, res) => {
  try {
...
export const handleMarkAsCompleted = async (req, res) => {
  try {
    const { courseId } = req.params;
    const userId = req.userId;
...
export const handleMarkAsInCompleted = async (req, res) => {
  try {
    const { courseId } = req.params;
    const userId = req.userId;
